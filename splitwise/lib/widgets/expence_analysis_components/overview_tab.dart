    ...
    switch (index) {
      ...
      case 1:
        return _buildMonthlyExpensesCard(
          ...
          colorScheme,
          textTheme,
          expensesFuture: getMonthlyExpenses(expenseService, group.id),
      ...
      case 2:
        return _buildExpenseDistributionCard(
          ...
          colorScheme,
          textTheme,
          balancesFuture: expenseService.calculateBalances(group.id),
          currency: settingsService.currency,
              ...
              child: ClipRRect(
                ...
                child: FutureContentBuilder<Map<String, double>>(
                  ...
                  emptyDataDescription:
                      'Add expenses to track monthly patterns',
